...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_vqa_loader \
        ...
        --question-file instructions/OKVQA/okvqa_val.jsonl \
...
python -m llava.eval.eval_okvqa \
    --annotation-file instructions/OKVQA/mscoco_val2014_annotations.json \
    --question-file instructions/OKVQA/OpenEnded_mscoco_val2014_questions.json \
