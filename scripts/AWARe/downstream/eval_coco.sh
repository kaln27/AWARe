...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_caption_loader \
        ...
        --question-file instructions/COCO-Caption/llava_caption_mscoco_test.jsonl \
...
output_file=$RESULT_DIR/$SPLIT/llava-v1.5-7b-coco.jsonl
...
python -m llava.eval.eval_caption \
    --annotation-file instructions/COCO-Caption/captions_test5k.json \
